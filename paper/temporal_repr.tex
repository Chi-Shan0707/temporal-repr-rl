...
As expected, the MLP baseline (which lacks recurrence) fails to learn the task (Return $= -2.0$ across all 5 seeds, R$^2(t) \approx 0$), confirming that temporal tracking requires recurrent state.
